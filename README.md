...
- **LightDM** como display manager (sesión Sway).
...
- **Snap** (`snapd`; borra `nosnap.pref` si existe), **Flatpak + Flathub**, **Homebrew** (linuxbrew; `brew shellenv` en fish, no un `.bashrc` hardcodeado).
