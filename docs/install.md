...
5. **Instala paquetes** (ver tabla abajo), incluyendo **curl**, **git**, **Node.js latest**, **gh**, **Zed**, **UPower**, **zram**, firmware según GPU/NIC y **Brave Origin** (repo oficial https://brave.com/origin/linux/; default XDG).
...
| Brave Origin | Repo oficial APT ([brave.com/origin/linux](https://brave.com/origin/linux/)); paquete `brave-origin`. Default XDG para navegación web. |
