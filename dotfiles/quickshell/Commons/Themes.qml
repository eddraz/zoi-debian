...
Singleton {
    ...
    function parseWallpaperColors(text) {
        ...
        wallpaperColors = {
            ...
            "dark_background": map.dark_background || map.mantle || map.background,
            "darker_background": map.darker_background || map.crust || map.background,
            "lighter_background": map.lighter_background || map.surface || map.background,
            "foreground": map.foreground || "#cdd6f4",
            "dark_foreground": map.dark_foreground || map.muted || "#6c7086",
            "light_foreground": map.light_foreground || map.foreground || "#e0e2f0",
            "bright_foreground": map.bright_foreground || map.foreground || "#ffffff",
            "selection": map.selection || map.surface || "#2a3c46",
            "muted": map.muted || "#9fa8ad",
            "accent": map.accent || "#89b4fa",
            "red": map.red || map.urgent || "#f38ba8",
            "yellow": map.yellow || "#f9e2af",
            "orange": map.orange || map.peach || "#fab387",
            "green": map.green || "#a6e3a1",
            "cyan": map.cyan || "#94e2d5",
            "blue": map.blue || map.accent || "#89b4fa",
            "magenta": map.magenta || "#cba6f7",
            "brown": map.brown || "#75493d",
            "bright_red": map.bright_red || map.red || "#ff7a93",
            "bright_yellow": map.bright_yellow || map.yellow || "#ff9e64",
            "bright_green": map.bright_green || map.green || "#b9f27c",
            "bright_cyan": map.bright_cyan || map.cyan || "#0db9d7",
            "bright_blue": map.bright_blue || map.blue || "#7da6ff",
            "bright_magenta": map.bright_magenta || map.magenta || "#bb9af7",
            "mantle": map.mantle || map.dark_background || map.background,
            "crust": map.crust || map.darker_background || map.background,
            "surface": map.surface || map.lighter_background || map.background,
            "overlay": map.overlay || map.muted || "#6c7086",
            "urgent": map.urgent || map.red || "#f38ba8",
            "peach": map.peach || map.orange || "#fab387"
        };
